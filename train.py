...
def worker_main(rank: int, world_size: int, config: DictConfig):
    ...
    trainer = TrainerClass(policy, config, config.seed, config.local_run_dir, reference_model=reference_model, rank=rank, world_size=world_size, harmless_reward_model= harmless_reward_model)
